          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              ...
              <form method="POST" action="{{route('register')}}">
                  ...
                  <div class="pt-1 mb-4">
                    <button id='btnLogin' class="btn btn-dark btn-lg btn-block" type="submit">{{ __('Submit') }}</button>
                    <p id='container-APLogin' class="mb-5 pb-lg-2">have an account yet? <a class="" href="{{ route('login') }}">{{ __('Login Here') }}</a></p>
                  </div>
                </form>
