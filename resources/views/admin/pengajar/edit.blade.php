...
<div class="container px-5 my-5">
    <form method="POST" action="{{ route('pengajar.update',$pengajar->id) }}" id="contactForm" data-sb-form-api-token="API_TOKEN">
    @csrf
    @method('PUT')
        ...
        <div class="form-floating mb-3">
            Gender <br>
            <input name="gender" value="{{$pengajar->id}}" id="gender" type="radio" placeholder="gender" data-sb-validations="required" /> L <br>
            <input name="gender" value="{{$pengajar->id}}" id="gender" type="radio" placeholder="gender" data-sb-validations="required" /> P
        ...
        <div class="form-floating mb-3">
            <input class="form-control" name="foto" value="{{$pengajar->foto}}" id="foto" type="text" placeholder="Foto" data-sb-validations="required" />
